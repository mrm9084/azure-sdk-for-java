...
public class FeatureManagementProperties extends HashMap<String, Object> {
    ...
    public void putAll(Map<? extends String, ? extends Object> m) {
        ...
        Map<? extends String, ? extends Object> features = removePrefixes(m, "featureManagement", 1);

        if (!features.isEmpty()) {
            m = features;
        }

        Map<? extends String, ? extends Object> featureFlags = removePrefixes(m, "feature-flags", 2);
        Map<? extends String, ? extends Object> dynamicFeatures = removePrefixes(m, "dynamic-features", 2);
    ...
    private Map<? extends String, ? extends Object> removePrefixes(Map<? extends String, ? extends Object> m,
        ...
        if (m.size() == size && m.containsKey(prefix)) {
