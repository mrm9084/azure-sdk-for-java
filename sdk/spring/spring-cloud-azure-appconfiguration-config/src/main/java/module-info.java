...
module com.azure.spring.cloud.appconfiguration.config {
    ...
    exports com.azure.spring.cloud.appconfiguration.config.implementation.feature.entity;
    exports com.azure.spring.cloud.appconfiguration.config;
    exports com.azure.spring.cloud.appconfiguration.config.implementation.http.policy;
    exports com.azure.spring.cloud.appconfiguration.config.implementation.properties;
    exports com.azure.spring.cloud.appconfiguration.config.implementation;
    exports com.azure.spring.cloud.appconfiguration.config.implementation.stores;
