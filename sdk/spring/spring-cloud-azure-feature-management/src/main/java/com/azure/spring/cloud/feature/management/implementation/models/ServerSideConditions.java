...
public class ServerSideConditions {
     ...
     */
    public ServerSideConditions setRequirementType(String requirementType) {
     ...
     */
    public ServerSideConditions setClientFilters(Map<Integer, FeatureFilterEvaluationContext> clientFilters) {
